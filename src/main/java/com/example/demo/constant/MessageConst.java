...
public class MessageConst {
	...
	/** 問題登録画面：既に登録されている問題ID */
	public static final String MAKE_QUESTION_EXISTED_QUESTION_ID = "makeQuestion.existedQuestionId";
	
	/** 問題登録画面：問題登録完了 */
	public static final String MAKE_QUESTION_RESIST_SUCCEED = "makeQuestion.resistSucceed";
